    ...
    public function getObject(Mage_Catalog_Model_Product $product)
    {
        ...
        if (false === isset($defaultData['thumbnail_url'])) {
            ...
            try {
                ...
                $customData['thumbnail_url'] = str_replace(['https://', 'http://'], '//',
                    Mage::getDesign()->getSkinUrl($thumb->getPlaceholder()));
            }
        }
        ...
        if (false === isset($defaultData['image_url'])) {
            ...
            try {
                ...
                $customData['image_url'] = str_replace(['https://', 'http://'], '//',
                    Mage::getDesign()->getSkinUrl($image->getPlaceholder()));
            }
