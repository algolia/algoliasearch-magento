...
class Algolia_Algoliasearch_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    {
        $attrs = \Zend_Serializer::unserialize(Mage::getStoreConfig(self::AUTOCOMPLETE_SECTIONS, $storeId));
    ...
    {
        $attrs = \Zend_Serializer::unserialize(Mage::getStoreConfig(self::EXCLUDED_PAGES, $storeId));
    ...
    public function getSortingIndices($storeId = null)
    {
        ...
        $attrs = \Zend_Serializer::unserialize(Mage::getStoreConfig(self::SORTING_INDICES, $storeId));
    ...
    {
        $attrs = \Zend_Serializer::unserialize(Mage::getStoreConfig(self::CATEGORY_ATTRIBUTES, $storeId));
    ...
    {
        $attributes = \Zend_Serializer::unserialize(Mage::getStoreConfig(self::PRODUCT_ATTRIBUTES, $storeId));

        $facets = \Zend_Serializer::unserialize(Mage::getStoreConfig(self::FACETS, $storeId));
        $attributes = $this->addIndexableAttributes($attributes, $facets, '0');

        $sorts = \Zend_Serializer::unserialize(Mage::getStoreConfig(self::SORTING_INDICES, $storeId));
        $attributes = $this->addIndexableAttributes($attributes, $sorts, '0');

        $customRankings = \Zend_Serializer::unserialize(Mage::getStoreConfig(self::PRODUCT_CUSTOM_RANKING, $storeId));
    ...
    {
        $attrs = \Zend_Serializer::unserialize(Mage::getStoreConfig(self::FACETS, $storeId));
        foreach ($attrs as &$attr) {
            if ($attr['type'] == 'other') {
    ...
    {
        $synonyms = \Zend_Serializer::unserialize(Mage::getStoreConfig(self::SYNONYMS, $storeId));
    ...
    {
        $onewaySynonyms = \Zend_Serializer::unserialize(Mage::getStoreConfig(self::ONEWAY_SYNONYMS, $storeId));
    ...
    public function getNonCastableAttributes($storeId = null)
    {
        ...
        $config = \Zend_Serializer::unserialize(Mage::getStoreConfig(self::NON_CASTABLE_ATTRIBUTES, $storeId));
    ...
    {
        $attrs = \Zend_Serializer::unserialize(Mage::getStoreConfig($configName, $storeId));
