...
class Algolia_Algoliasearch_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    const ENABLE_INDEXING = 'algoliasearch/credentials/enable_indexing';
    ...
    public function isEnabledIndexing($storeId = null)
    {
        return Mage::getStoreConfigFlag(self::ENABLE_INDEXING, $storeId);
    }
